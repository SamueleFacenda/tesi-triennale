...
nell'ambito del web semantico. È uno standard essenziale con il potenziale per essere esteso,
...
ottimizzati per query che contengono scansioni su grandi porzioni del modello quanto sull'accesso casuale e sul collegamento dei nodi.
...
dei cantieri. Parte da una rappresentazione RDF dei dati BIM e usa l'ontologia V4Design come base di costruzione semantica.
...
standard basato su RDF per la gestione di eventi sequenziali e serie di dati temporali. L'utilizzo di Time Series Snippets inoltre
