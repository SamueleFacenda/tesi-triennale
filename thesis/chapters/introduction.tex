...
tramite modelli RDF, mantenendo la stessa espressività dell'originale e quindi la completezza.
...
del framework) è il motore di query utilizzato e la sua configurazione. Nello specifico viene impiegato QLever~\cite{bast2017qlever,bast2022qlever} con vocabolario
